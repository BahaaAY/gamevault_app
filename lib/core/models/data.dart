...
List<Game> games2 = [
  ...
  Game(
    "Forza Horizon 5",
    GameImage(
        "https://assets-prd.ignimgs.com/2021/08/24/forza-horizon-5-button-fin-1629830068379.jpg",
        ""),
    "",
    "Naughty Dog",
  ),
  ...
  Game(
    "Just Cause 4",
    GameImage(
        "https://m.media-amazon.com/images/M/MV5BMzI2NzNjYjctMmRiZS00MDRjLWFmNDQtOGQzOWVlZjVhOTg2XkEyXkFqcGdeQXVyNzg3NjQyOQ@@._V1_FMjpg_UX1000_.jpg",
        ""),
    "",
    "Avalanche Studios",
  ),
...
List<Game> featuredGames = [
  ...
  Game(
    ...
    GameImage(
        "https://image.api.playstation.com/vulcan/img/cfn/11307AuFZKrw6DorTNAC3WdWnAKpEx70fOdGFLJgROeERlzQLhhUi7N1ttK_O6tq-_Kp-D9FEbVIJ0btI5-gfeGPN9Ib8vhy.png",
        ""),
    "",
    "CyberConnect2",
  ),
